...
const FQN_PREFIX = 'my-amazing-team:';
const FACETS_SOURCE_TEMPLATE = 'https://github.com/flair-sdk/examples/blob/v{VERSION}/src/{ARTIFACT_KEY}.sol';
const FACETS_AUTHOR = 'my-amazing-team.eth';
